...
<Warning>
  Images do not yet support the `language-COUNTRY` notation. This will be improved in the future. Take a read through the [image language](/for-image/languages) documentation to learn how to *partly* get around this limitation.
</Warning>
