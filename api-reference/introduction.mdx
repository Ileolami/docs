...
## 2. Credentials
<Card >
  <label className=" border p-2 rounded-lg w-24">HEADER</label>
  <div className="flex flex-col">
    <input
      type="text"
      placeholder="Authorization"
      className="block min-w-0 grow py-1.5 pr-3 pl-5 border rounded-lg mt-5 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 mb-4"
    />
